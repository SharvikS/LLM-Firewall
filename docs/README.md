...
Project documentation, organized by purpose. The top-level [README](../README.md)
...
## reference/ — provider & testing reference
- [PROVIDERS.md](reference/PROVIDERS.md) — supported upstream LLM providers
- [All_Gateways.md](reference/All_Gateways.md)
...
## assets/
Screenshots and images referenced by the docs and the top-level README.
