...
const ACTION_META: Record<string, { label: string; color: string; bg: string }> = {
  ...
  BROWSER_DLP_REDACT:   { label: 'Browser Redact',   color: 'text-yellow-400', bg: 'bg-yellow-400/10' },
  BROWSER_DLP_OVERRIDE: { label: 'Browser Override', color: 'text-orange-400', bg: 'bg-orange-400/10' },
  DLP_FLAG_RAISED:      { label: '🚩 Flag Raised',   color: 'text-red-400',    bg: 'bg-red-500/15' },
};
